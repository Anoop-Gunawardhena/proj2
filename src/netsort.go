...
func listenForData(ch chan<- string, cType string, host string, port string, servers int) {
...
func handleConnectionListen(conn net.Conn, ch chan<- string)  {
